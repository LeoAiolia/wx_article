...
有开发者在使用 CodeGenie 时，明明在设置里配置的是国内的 `Yxr-MiniMax-M3` 模型，结果输入“你是什么大模型”时，AI 却在 Deep Thinking 之后无比诚实地回答道：

> “我是 Claude，由 Anthropic 打造的大语言模型，专门为 HarmonyOS 开发场景做了优化和定制……”

开发者惊了，追问道：“我配置的明明是 deepseek/minimax。”
